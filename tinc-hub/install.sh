...
header() {
    echo ""
    echo -e "${BLUE}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${BLUE}${BOLD}  ⚙  Tinc Hub v${TINC_HUB_VERSION} — Kurulum${NC}"
    echo -e "${BLUE}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
}
...
# Dizinler
mkdir -p /opt/tinc-hub/{shared,agents}
...
if [[ ! -f /etc/tinc-hub/config.env ]]; then
    ...
    warn "Config oluşturuldu: /etc/tinc-hub/config.env"
    warn "Lütfen ROUTER_PASS ve diğer değerleri düzenleyin!"
else
    info "Config mevcut: /etc/tinc-hub/config.env"
fi
...
/opt/tinc-hub/venv/bin/pip install --quiet \
...
DASH_PORT=$(grep "DASHBOARD_PORT" /etc/tinc-hub/config.env 2>/dev/null | cut -d= -f2 | tr -d ' ' || echo "9010")
...
echo -e "  ${BOLD}Config:${NC}    /etc/tinc-hub/config.env"
echo -e "  ${BOLD}Loglar:${NC}    /var/log/tinc-hub/"
echo -e "  ${BOLD}Veriler:${NC}   /var/lib/tinc-hub/tinc-hub.db"
echo ""
echo -e "  Durum:     ${BOLD}systemctl status 'tinc-hub-*'${NC}"
echo -e "  Durdur:    ${BOLD}systemctl stop 'tinc-hub-*'${NC}"
