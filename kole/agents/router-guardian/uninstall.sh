#!/usr/bin/env bash
# ──────────────────────────────────────────────────────────────
# TINC Köle — Router Guardian uninstall.sh
# ──────────────────────────────────────────────────────────────
set -euo pipefail
...
echo ""
echo "ℹ️  Log dosyaları /var/log/kole/${AGENT_ID}.log adresinde bırakıldı."
echo "   Silmek için: rm -f /var/log/kole/${AGENT_ID}.log"
