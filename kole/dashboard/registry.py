...
APPS_YAML = os.environ.get("KOLE_APPS_YAML", "/etc/kole/apps.yaml")
...
DEFAULT_YAML = """\
# TINC Köle Hub — Uygulama Kayıt Defteri
...
def save_apps(apps: list[dict]):
    ...
    with _lock:
        ...
        with open(APPS_YAML, "w", encoding="utf-8") as f:
            f.write("# TINC Köle Hub — Uygulama Kayıt Defteri\n")
